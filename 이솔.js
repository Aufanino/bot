...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + '𝓑𝓞𝓣 𝓘𝓢𝓐𝓛𝓛\n' 
            + 'ORG: FAISAL WAPI;\n' //ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=6289630267618:+62896-3026-7618\n'  
            + 'END:VCARD' 
prefix = '!' //terserah mau ganti apa gak
blocked = [] //biarin aja eror jngn nyesel
replitx = ' *𝓦𝓔𝓛𝓒𝓞𝓜𝓔 𝓑𝓞𝓣 𝓘𝓢𝓐𝓛𝓛* ' 
ari = '*FAISAL WAPI*'
limitawal = 50 
memberlimit = 1  
namabot = '𝓑𝓞𝓣 𝓘𝓢𝓐𝓛𝓛'
cr = '*「 𝓑𝓞𝓣 𝓘𝓢𝓐𝓛𝓛 」*' 
status = "OWNER YANG PUNYA BOT JOMBLO NIH" 
...
const ownerNumber = ["6289630267618@s.whatsapp.net"]
const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
if(time2 < "23:59:00"){
var ucapanWaktu = 'Selamat Malam Kawan'
                                        }
if(time2 < "19:00:00"){
var ucapanWaktu = 'Selamat Petang Kawan'
                                         }
if(time2 < "18:00:00"){
var ucapanWaktu = 'Selamat Sore Kawan'
                                         }
if(time2 < "15:00:00"){
var ucapanWaktu = 'Selamat Siang Kawan'
                                         }
if(time2 < "11:00:00"){
var ucapanWaktu = 'Selamat Pagi Kawan'
                                         }
if(time2 < "05:00:00"){
var ucapanWaktu = 'Selamat Malam Kawan'
                                         }
...
console.log(color('WELCOME DI WA CONNECTION KAWAN ISALL, SILAHKAN SCAN KODE DI BAWAH','green'))
console.log(color('JIKA KODE QR TIDAK MUNCUL SILAHLAN HAPUS FAISALWAPI.JSON YA KETIK MC','blue'))
...
client.on('credentials-updated', () => {
   ...
   fs.writeFileSync('./faisalwapi.json', JSON.stringify(authInfo, null, '\t'))
})
fs.existsSync('./faisalwapi.json') && client.loadAuthInfo('./faisalwapi.json')
client.connect();
...
- *Pesan :* ${body ? body : '-'}\`\`\``
	...
	client.on('message-new', async (mek) => {
		...
		try {
            ...
            //-
            const freply = { key: { fromMe: false, participant: `6289630267618@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": `${YahahaHayyuk}`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')} } }
			const fkontak = { key: { fromMe: false, participant: `6289630267618@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${YahahaHayyuk}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${YahahaHayyuk},;;;\nFN:${YahahaHayyuk},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail": fs.readFileSync('./lib/logo.jpeg')}}}
			const ftoko = { key: { fromMe: false, participant: `6289630267618@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek ItsAra`, "productImageCount": 9999 }, "businessOwnerJid": `6289630267618@s.whatsapp.net`}}}
...
case 'addbadword':
                    ...
                    if (args.length < 1) return reply( `Kirim perintah ${prefix}addbadword [kata kasar]. contoh ${prefix}addbadword TOLOL`)
...
//=============== BATES COK ===================//
				...
				reply(`Berhasil menambahkan admin wa.me/${admm} `)
				break
                case 'unadmin':
				if (!isOwner) return reply(ind.ownerb())
				admm = body.slice(9)
				...
				fs.writeFileSync('./database/pengguna/admin.json', JSON.stringify(adm))
				reply(`Berhasil menambahkan admin  wa.me/${adm} `)
				break
                case 'premium':
				if (!isOwner) return reply(ind.ownerb())
				premm = body.slice(9)
		...
		case 'daftar':
                			...
                			if (umurUser < 12) return reply(`your age is too young minimum 12 years`)
                    			...
                    			checkLimit(sender)
                    			console.log(color('[𝓡𝓔𝓖𝓘𝓢𝓣𝓔𝓡]'), color(time, 'yellow'), 'Name:', color(namaUser, 'cyan'), 'Age:', color(umurUser, 'cyan'), 'Serial:', color(serialUser, 'cyan'), 'in', color(sender || groupName))
                			} else {
                    			addRegisteredUser(sender, namaUser, umurUser, time, serialUser)
                    			await client.sendMessage(from, ppimg, image, {quoted: mek, caption: ind.registered(namaUser, umurUser, serialUser, time, sender)})
                    			addATM(sender)
                    			addLevelingId(sender)
                    			checkLimit(sender)
                    			console.log(color('[𝓡𝓔𝓖𝓘𝓢𝓣𝓔𝓡]'), color(time, 'yellow'), 'Name:', color(namaUser, 'cyan'), 'Age:', color(umurUser, 'cyan'), 'Serial:', color(serialUser, 'cyan'))
                			}
				        break
		case 'mining':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					const one = Math.ceil(Math.random() * 1000000)
					addLevelingXp(sender, one)
					await reply(`Kamu bagian dari prabayar, aku akan berikan sebanyak *${one}Xp* untuk anda`)
                 					     }else{
					const mining = Math.ceil(Math.random() * 100000)
					addLevelingXp(sender, mining)
					await reply(`╚»𝙎𝙀𝙇𝘼𝙈𝘼𝙏«╝ ${pushname} kamu mendapatkan *${mining}𝐗𝐏*`)
					}
					await limitAdd(sender)
					break
		case 'help': 
		case 'menu':
            costum(`*SABAR MENU SEDANG LOADING ‼️*`, text, tescuk, ari)
            if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
 ...
 ║• YouTube : https://tinyurl.com/26ytadminn
 ║• Instagram : https://tinyurl.com/26igadminn
 ║• Nomor Owner : https://tinyurl.com/26WaOwner
 ║
 ╠════【 ᴊᴀᴅᴡᴀʟ ᴀᴋᴛɪᴘ 】════
 ║
 ║• 24 jam ( bila ada paket )
 ║• ${status}
 ║• ${tampilHari} ${pushname}
 ║
 ╠════【 ᴡᴀᴋᴛᴜ 】
...
if (args.length == 0) return reply(`Idnya mana kak?`)
		...
		case 'group':
            ...
            case 'creator':
            case 'developer':
                  client.sendMessage(from, {displayname: "ISALL", vcard: vcard}, MessageType.contact, { quoted: mek})
...
case 'antilink':
					...
					if (Number(args[0]) === 1) {
						if (isAntiLink) return reply('anti link sudah aktif✔️')
						antilink.push(from)
						fs.writeFileSync('./database/kelompok/antilink.json', JSON.stringify(antilink))
						reply('Sukses mengaktifkan anti link di group ini ✔️')
						client.sendMessage(from,`「 *NOTICE GROUP* 」Jika bukan admin jangan kirim link group`, text)
					} else if (Number(args[0]) === 0) {
						if (isAntiLink) return reply('Mode anti link sudah Mati')
			...
			case 's':
				...
				case 'join':  
                    if (isBanned) return reply(ind.baned()) 
                    if (args.length < 1) return reply(`contoh ${prefix}join Link Grup`)
                    ...
                    fernazer.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, optionsp, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "caption": `SUBSCRIBE HAH ISALL`} } } })                    
                    reply('BOT AKAN SEGERA MASUK. SUBSCRIBE HAH ISALL')
		case 'clone':
					if (!isGroup) return reply(ind.groupo())
...
// CASE BY FERNAZER
   	...
   	case 'wibu': case 'hebat': case 'sadboy': case 'sadgirl':  
        ...
        case 'kata':  
				...
				client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*SUBSCRIBE HAH ISALL*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('lib/logo.jpg')} } }, caption: 'Nih Hasilnya Kak...'})
				break
				case 'hekelserti': 				
				// Subscribe Yoo
				if (!isRegistered) return reply(ind.noregis())
...
break
              ...
              reply('SAYA HECKED BUKAN SATPOL')
...
║╠ Contoh: 
║╠ #suratto 6289630267618|Hai Juga
║╚▸
╚═══ ◤ *${namabot}* ◢ `
...
client.sendMessage(from, Mau, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		...
		if (budy.includes(`6289630267618`)) {
                  reply(`Jangan Tag Saya`)
